<template>
  <v-app>
    <v-system-bar
      ...
      absolute
    >
    <span class="white--text"><span class="hidden-xs-only"> Tool is deprecated and data will be out of date.  Please use <a href="https://data.open-contracting.org/">Official OCDS Data Registry.</a> Data will be deleted on 1st September 2023.</span> </span>
    </v-system-bar>
    <v-app-bar
      app
      absolute
